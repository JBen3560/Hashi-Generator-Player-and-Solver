...
bool noNeighbors(int r, int c, GridPosition** board){
...
bool validBranch(int dist, char dir, int r, int c, GridPosition** board){
...
void MysteryMachine::setUpBoard(int r, int c, GridPosition** board){
    // Place island
